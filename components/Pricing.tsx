...
export const Pricing = () => {
  return (
    <section id="pricing" className="py-24 bg-parchment border-t-2 border-ink relative">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 items-end">
          ...
          <div className="bg-ink text-parchment border-2 border-ink w-full md:w-96 p-8 shadow-hard-xl text-left relative z-10 md:-translate-y-6">
            <div className="absolute -top-4 left-0 right-0 flex justify-center">
              <span className="bg-robin-green text-ink border-2 border-ink px-4 py-1 font-mono font-bold text-xs shadow-hard-sm uppercase">Most Wanted</span>
            </div>
            ...
            <Button variant="primary" className="w-full">Start the Rebellion</Button>
          </div>
